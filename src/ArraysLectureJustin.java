...
public class ArraysLectureJustin {
        ...
        public static void main(String[] args) {
            ...
            System.out.println(prices[0]); // prints out 0.0 because it is double
...
//            System.out.println(numbers[2]); // default value because in index 2, we haven't assing anything yet.

            // or   int [] numbers = {1, 2, 0}
...
////
//                System.out.println(words.equals(testArray));  // prints out false
...
//            System.out.println(Arrays.binarySearch(meme,"fox")); // what??? prints -5 bc wasn't found
